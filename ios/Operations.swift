...
class Operations {
    ...
    let FeedChannel = OperationDefinition(
        "FeedChannel",
        .query, 
        "query FeedChannel($id:ID!){channel:alphaFeedChannel(id:$id){__typename ...FeedChannelFull}}fragment FeedChannelFull on FeedChannel{__typename about id myRole photo shortname subscribed subscribersCount title}",
        FeedChannelSelector
    )
    ...
    let FeedMyChannels = OperationDefinition(
        "FeedMyChannels",
        .query, 
        "query FeedMyChannels($after:ID,$first:Int!){channels:alphaFeedMyChannels(after:$after,first:$first){__typename cursor items{__typename ...FeedChannelFull}}}fragment FeedChannelFull on FeedChannel{__typename about id myRole photo shortname subscribed subscribersCount title}",
