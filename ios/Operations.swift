...
private let AuthResolveShortNameSelector = obj(
            field("alphaResolveShortName", "item", arguments(fieldValue("shortname", refValue("shortname"))), obj(
                    ...
                    inline("User", obj(
                        ...
                        field("firstName", "firstName", notNull(scalar("String"))),
                        field("lastName", "lastName", scalar("String")),
                        field("photo", "userPhoto", scalar("String")),
                        field("externalSocialImage", "externalSocialImage", scalar("String")),
                        field("online", "online", notNull(scalar("Boolean"))),
                        field("currentVoiceChat", "currentVoiceChat", obj(
                                field("__typename", "__typename", notNull(scalar("String"))),
                    ...
                    inline("Organization", obj(
                        ...
                        field("id", "id", notNull(scalar("ID"))),
                        field("name", "name", notNull(scalar("String"))),
                        field("photo", "orgPhoto", scalar("String")),
                        field("about", "about", scalar("String")),
                        field("applyLinkEnabled", "applyLinkEnabled", notNull(scalar("Boolean"))),
                        field("applyLink", "applyLink", scalar("String")),
                        field("externalSocialImage", "externalSocialImage", scalar("String")),
...
class Operations {
    ...
    let Account = OperationDefinition(
        "Account",
        .query, 
        "query Account{me:me{__typename id name photo shortname email}myProfile{__typename id authEmail}sessionState:sessionState{__typename isLoggedIn isActivated isProfileCreated isAccountActivated isAccountExists isAccountPicked isCompleted isBlocked}myPermissions{__typename roles}}",
        AccountSelector
    )
    ...
    let AccountAppInviteInfo = OperationDefinition(
        ...
        .query, 
        "query AccountAppInviteInfo($inviteKey:String!){invite:alphaInviteInfo(key:$inviteKey){__typename id creator{__typename ...UserSmall}}appInvite:appInviteInfo(key:$inviteKey){__typename inviter{__typename ...UserSmall}}}fragment UserSmall on User{__typename id name firstName photo shortname isBot}",
    ...
    let MessageMultiSpan = OperationDefinition(
        "MessageMultiSpan",
        .query, 
        "query MessageMultiSpan($id:ID!){message(messageId:$id){__typename id spans{__typename ... on MessageSpanMultiUserMention{__typename users{__typename ...UserSmall}}}}}fragment UserSmall on User{__typename id name firstName photo shortname isBot}",
    ...
    let MyBlackList = OperationDefinition(
        "MyBlackList",
        .query, 
        "query MyBlackList{myBlackList{__typename ...UserShort isBanned isMeBanned}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
        MyBlackListSelector
    )
    ...
    let MyCommunities = OperationDefinition(
        "MyCommunities",
        .query, 
        "query MyCommunities{myCommunities{__typename ...OrganizationShort isOwner:betaIsOwner isAdmin:betaIsAdmin}}fragment OrganizationShort on Organization{__typename id name photo shortname about isCommunity:alphaIsCommunity private:alphaIsPrivate membersCount isAdmin:betaIsAdmin membersCanInvite:betaMembersCanInvite featured:alphaFeatured}",
        MyCommunitiesSelector
    )
    let MyContacts = OperationDefinition(
        "MyContacts",
        .query, 
        "query MyContacts($first:Int!,$after:String){myContacts(first:$first,after:$after){__typename items{__typename id user{__typename ...UserShort}}cursor}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
        MyContactsSelector
    )
    let MyContactsSearch = OperationDefinition(
        "MyContactsSearch",
        .query, 
        "query MyContactsSearch($query:String,$first:Int!,$after:String,$page:Int){myContactsSearch(query:$query,first:$first,after:$after,page:$page){__typename edges{__typename node{__typename ...UserShort}}pageInfo{__typename hasNextPage currentPage}}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
    ...
    let OrganizationMembers = OperationDefinition(
        "OrganizationMembers",
        .query, 
        "query OrganizationMembers($organizationId:ID!,$first:Int,$after:ID){organization(id:$organizationId){__typename id members:alphaOrganizationMembers(first:$first,after:$after){__typename role user{__typename ...UserShort}}}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
        OrganizationMembersSelector
    )
    let OrganizationMembersSearch = OperationDefinition(
        "OrganizationMembersSearch",
        .query, 
        "query OrganizationMembersSearch($orgId:ID!,$query:String,$first:Int!,$after:String,$page:Int){orgMembersSearch(orgId:$orgId,query:$query,first:$first,after:$after,page:$page){__typename edges{__typename node{__typename role user{__typename ...UserShort}}cursor}pageInfo{__typename hasNextPage}}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
    ...
    let SuperAdmins = OperationDefinition(
        "SuperAdmins",
        .query, 
        "query SuperAdmins{superAdmins{__typename role user{__typename ...UserShort}email}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
        SuperAdminsSelector
    )
    ...
    let VoiceChatListeners = OperationDefinition(
        "VoiceChatListeners",
        .query, 
        "query VoiceChatListeners($id:ID!,$first:Int!,$after:String){voiceChatListeners(id:$id,first:$first,after:$after){__typename items{__typename ...VoiceChatParticipant}cursor}}fragment VoiceChatParticipant on VoiceChatParticipant{__typename id user{__typename ...UserSmall followersCount}status handRaised}fragment UserSmall on User{__typename id name firstName photo shortname isBot}",
    ...
    let OrganizationAddMember = OperationDefinition(
        ...
        .mutation, 
        "mutation OrganizationAddMember($userIds:[ID!],$organizationId:ID!){alphaOrganizationMemberAdd(userIds:$userIds,organizationId:$organizationId){__typename role user{__typename ...UserShort}}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
    ...
    let SuperAccountMemberAdd = OperationDefinition(
        ...
        .mutation, 
        "mutation SuperAccountMemberAdd($accountId:ID!,$userId:ID!){superAccountMemberAdd(id:$accountId,userId:$userId){__typename id members{__typename ...UserShort}}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
        SuperAccountMemberAddSelector
    )
    let SuperAccountMemberRemove = OperationDefinition(
        "SuperAccountMemberRemove",
        .mutation, 
        "mutation SuperAccountMemberRemove($accountId:ID!,$userId:ID!){superAccountMemberRemove(id:$accountId,userId:$userId){__typename id members{__typename ...UserShort}}}fragment UserShort on User{__typename id name firstName photo online lastSeen isBot shortname}",
