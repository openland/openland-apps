...
class Operations {
    ...
    let FeedSubscriptions = OperationDefinition(
        "FeedSubscriptions",
        .query, 
        "query FeedSubscriptions{channels:alphaFeedMySubscriptions{__typename ...FeedChannelFull}}fragment FeedChannelFull on FeedChannel{__typename about id isGlobal myRole photo postsCount shortname socialImage subscribed subscribersCount title}",
