...
private let BuyProChatSubscriptionSelector = obj(
...
class Operations {
    ...
    let BuyProChatSubscription = OperationDefinition(
        "BuyProChatSubscription",
        .mutation, 
        "mutation BuyProChatSubscription($chatId:ID!){betaBuyProChatSubscription(chatId:$chatId)}",
        BuyProChatSubscriptionSelector
    )
    ...
    func operationByName(_ name: String) -> OperationDefinition {
        ...
        if name == "BuyProChatSubscription" { return BuyProChatSubscription }
