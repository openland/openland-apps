...
import { withSuperAccount, withSuperAccountActivate, withSuperAccountSuspend, withSuperAccountMemberAdd, UserSelect, withSuperAccountFeatureAdd, withSuperAccountFeatureRemove } from '../../api';
...
export default withApp('super-admin', withSuperAccount((props) => {
    ...
    return (
        <AppContent>
            ...
            <XCard shadow="medium">
                <XCard.Header text="Features" description={props.data.superAccount.features.length + ' total'}>
