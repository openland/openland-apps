        ...
        <AppContent>
            <XCard shadow="medium" separators={true}>
                ...
                <XCard.PropertyList>
                    ...
                    {props.data.project.extrasUrl && <XCard.Property title="Link" ><XLinkExternal path={props.data.project.extrasUrl}>{props.data.project.extrasUrl}</XLinkExternal></XCard.Property>}
                </XCard.PropertyList>
            </XCard>
