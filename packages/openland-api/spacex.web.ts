...
const UserFullSelector = obj(
            ...
            field('status', 'status', args(), scalar('String')),
...
export const Operations: { [key: string]: OperationDefinition } = {
    ...
    ProfileCreate: {
        kind: 'mutation',
        name: 'ProfileCreate',
        body: 'mutation ProfileCreate($input:ProfileInput!,$inviteKey:String){profileCreate(input:$input,inviteKey:$inviteKey){__typename id firstName lastName photoRef{__typename uuid crop{__typename x y w h}}status email phone website about location}}',
