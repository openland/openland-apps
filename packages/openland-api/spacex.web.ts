...
const MessageSenderSelector = obj(
            ...
            field('shortname', 'shortname', args(), scalar('String')),
            field('systemBadge', 'systemBadge', args(), scalar('String'))
        );
...
const VoiceChatEntitySelector = obj(
            ...
            field('handRaisedCount', 'handRaisedCount', args(), notNull(scalar('Int'))),
...
const VoiceChatSpeakerSelector = obj(
            field('__typename', '__typename', args(), notNull(scalar('String'))),
            field('status', 'status', args(), notNull(scalar('String'))),
...
const VoiceChatListenerSelector = obj(
            field('__typename', '__typename', args(), notNull(scalar('String'))),
            field('handRaised', 'handRaised', args(), scalar('Boolean')),
            fragment('VoiceChatParticipant', VoiceChatParticipantSelector)
        );
...
const VoiceChatFullSelector = obj(
            ...
            field('voiceChatListeners', 'voiceChatListeners', args(fieldValue("id", refValue('id')), fieldValue("first", intValue(12))), notNull(obj(
                    field('__typename', '__typename', args(), notNull(scalar('String'))),
                    field('items', 'items', args(), notNull(list(notNull(obj(
                            field('__typename', '__typename', args(), notNull(scalar('String'))),
                            fragment('VoiceChatParticipant', VoiceChatListenerSelector)
...
const VoiceChatHandRaisedSelector = obj(
            field('voiceChatHandRaised', 'voiceChatHandRaised', args(fieldValue("id", refValue('id')), fieldValue("first", refValue('first')), fieldValue("after", refValue('after'))), notNull(obj(
                    field('__typename', '__typename', args(), notNull(scalar('String'))),
                    field('items', 'items', args(), notNull(list(notNull(obj(
                            field('__typename', '__typename', args(), notNull(scalar('String'))),
                            field('id', 'id', args(), notNull(scalar('ID'))),
                    ...
                    field('cursor', 'cursor', args(), scalar('String')),
                    field('haveMore', 'haveMore', args(), notNull(scalar('Boolean')))
                )))
        );
...
const VoiceChatPrefetchSelector = obj(
            field('voiceChatEventsState', 'voiceChatEventsState', args(fieldValue("id", refValue('id'))), notNull(obj(
                    field('__typename', '__typename', args(), notNull(scalar('String'))),
                    field('state', 'state', args(), notNull(scalar('String')))
                ))),
            ...
            field('voiceChatListeners', 'voiceChatListeners', args(fieldValue("id", refValue('id')), fieldValue("first", intValue(2))), notNull(obj(
                    field('__typename', '__typename', args(), notNull(scalar('String'))),
                    field('items', 'items', args(), notNull(list(notNull(obj(
                            field('__typename', '__typename', args(), notNull(scalar('String'))),
                            fragment('VoiceChatParticipant', VoiceChatListenerSelector)
...
export const Operations: { [key: string]: OperationDefinition } = {
    Account: {
        kind: 'query',
        name: 'Account',
        body: 'query Account{me:me{__typename id name photo shortname email systemBadge}myProfile{__typename id authEmail}sessionState:sessionState{__typename isLoggedIn isActivated isProfileCreated isAccountActivated isAccountExists isAccountPicked isCompleted isBlocked}myPermissions{__typename roles}}',
    ...
    AccountAppInviteInfo: {
        ...
        body: 'query AccountAppInviteInfo($inviteKey:String!){invite:alphaInviteInfo(key:$inviteKey){__typename id creator{__typename ...UserSmall}}appInvite:appInviteInfo(key:$inviteKey){__typename inviter{__typename ...UserSmall}}}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    MessageMultiSpan: {
        ...
        body: 'query MessageMultiSpan($id:ID!){message(messageId:$id){__typename id spans{__typename ... on MessageSpanMultiUserMention{__typename users{__typename ...UserSmall}}}}}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    MyBlackList: {
        kind: 'query',
        name: 'MyBlackList',
        body: 'query MyBlackList{myBlackList{__typename ...UserShort isBanned isMeBanned}}fragment UserShort on User{__typename ...UserSmall online lastSeen}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    MyContacts: {
        kind: 'query',
        name: 'MyContacts',
        body: 'query MyContacts($first:Int!,$after:String){myContacts(first:$first,after:$after){__typename items{__typename id user{__typename ...UserShort}}cursor}}fragment UserShort on User{__typename ...UserSmall online lastSeen}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    RoomAdminMembers: {
        ...
        body: 'query RoomAdminMembers($roomId:ID!){roomAdmins(roomId:$roomId){__typename user{__typename ...UserShort}}}fragment UserShort on User{__typename ...UserSmall online lastSeen}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    SuperAdmins: {
        kind: 'query',
        name: 'SuperAdmins',
        body: 'query SuperAdmins{superAdmins{__typename role user{__typename ...UserShort}email}}fragment UserShort on User{__typename ...UserSmall online lastSeen}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    OrganizationAddMember: {
        ...
        body: 'mutation OrganizationAddMember($userIds:[ID!],$organizationId:ID!){alphaOrganizationMemberAdd(userIds:$userIds,organizationId:$organizationId){__typename role user{__typename ...UserShort}}}fragment UserShort on User{__typename ...UserSmall online lastSeen}fragment UserSmall on User{__typename id name firstName photo shortname isBot systemBadge}',
    ...
    VoiceChatCreate: {
        ...
        body: 'mutation VoiceChatCreate($input:VoiceChatInput!){voiceChatCreate(input:$input){__typename ...VoiceChatWithSpeakers}}fragment VoiceChatWithSpeakers on VoiceChat{__typename ...VoiceChatEntity speakers{__typename ...VoiceChatSpeaker}}fragment VoiceChatEntity on VoiceChat{__typename id title active adminsCount speakersCount listenersCount handRaisedCount parentRoom{__typename id title photo membership kind isChannel shortname organization{__typename id isAdmin:betaIsAdmin membersCanInvite:betaMembersCanInvite}isPremium role}pinnedMessage{__typename id message spans{__typename ...MessageSpan}}me{__typename ...VoiceChatMe}}fragment MessageSpan on MessageSpan{__typename offset length ... on MessageSpanUserMention{__typename user{__typename id name}}... on MessageSpanMultiUserMention{__typename offset length}... on MessageSpanOrganizationMention{__typename organization{__typename id name}}... on MessageSpanRoomMention{__typename room{__typename ... on PrivateRoom{__typename id user{__typename id name}}... on SharedRoom{__typename id title isPremium}}}... on MessageSpanLink{__typename url}... on MessageSpanDate{__typename date}}fragment VoiceChatMe on VoiceChatParticipant{__typename id user{__typename id photo firstName name shortname}status handRaised}fragment VoiceChatSpeaker on VoiceChatParticipant{__typename ...VoiceChatParticipant status}fragment VoiceChatParticipant on VoiceChatParticipant{__typename id user{__typename id photo firstName name}}',
