...
export interface SendMessage_sentMessage_message_reply_sender_primaryOrganization {
  __typename: "Organization";
  id: string;
  name: string;
  photo: string | null;
...
export interface SendMessage_sentMessage_message_reply_sender {
  __typename: "User";
  id: string;
  name: string;
  firstName: string;
...
export interface SendMessage_sentMessage_message_reactions {
  __typename: "MessageReaction";
  user: SendMessage_sentMessage_message_reactions_user;
  reaction: string;
}

export interface SendMessage_sentMessage_message_urlAugmentation_imageInfo {
  __typename: "FileMetadata";
  imageWidth: number | null;
  imageHeight: number | null;
}

export interface SendMessage_sentMessage_message_urlAugmentation_iconRef_crop {
  __typename: "ImageCrop";
  x: number;
  y: number;
  w: number;
...
export interface SendMessage_sentMessage_message_urlAugmentation_iconRef {
  __typename: "ImageRef";
  uuid: string;
  crop: SendMessage_sentMessage_message_urlAugmentation_iconRef_crop | null;
}

export interface SendMessage_sentMessage_message_urlAugmentation_iconInfo {
  __typename: "FileMetadata";
  imageWidth: number | null;
  imageHeight: number | null;
}
...
export interface SendMessage_sentMessage_message_urlAugmentation_user_AlphaOrganizationListing {
  __typename: "AlphaOrganizationListing" | "Organization" | "ChannelConversation";
}

export interface SendMessage_sentMessage_message_urlAugmentation_user_User_primaryOrganization {
  __typename: "Organization";
  id: string;
  name: string;
}

export interface SendMessage_sentMessage_message_urlAugmentation_user_User {
  __typename: "User";
  id: string;
  name: string;
  photo: string | null;
  primaryOrganization: SendMessage_sentMessage_message_urlAugmentation_user_User_primaryOrganization | null;
}

export type SendMessage_sentMessage_message_urlAugmentation_user = SendMessage_sentMessage_message_urlAugmentation_user_AlphaOrganizationListing | SendMessage_sentMessage_message_urlAugmentation_user_User;
...
export interface SendMessage_sentMessage_message_urlAugmentation {
  ...
  hostname: string | null;
  imageURL: string | null;
  imageInfo: SendMessage_sentMessage_message_urlAugmentation_imageInfo | null;
  iconRef: SendMessage_sentMessage_message_urlAugmentation_iconRef | null;
  iconInfo: SendMessage_sentMessage_message_urlAugmentation_iconInfo | null;
...
export interface SendMessage_sentMessage_message {
  ...
  reactions: SendMessage_sentMessage_message_reactions[];
