...
export const BadgeCreateMutation = typedMutation<Types.BadgeCreate, Types.BadgeCreateVariables>(Badges.BadgeCreateMutation);
export const BadgeCreateToRoomMutation = typedMutation<Types.BadgeCreateToRoom, Types.BadgeCreateToRoomVariables>(Badges.BadgeCreateToRoomMutation);
export const BadgeSetToRoomMutation = typedMutation<Types.BadgeSetToRoom, Types.BadgeSetToRoomVariables>(Badges.BadgeSetToRoomMutation);
export const BadgeUnsetToRoomMutation = typedMutation<Types.BadgeUnsetToRoom, Types.BadgeUnsetToRoomVariables>(Badges.BadgeUnsetToRoomMutation);
export const BadgeDeleteMutation = typedMutation<Types.BadgeDelete, Types.BadgeDeleteVariables>(Badges.BadgeDeleteMutation);
export const BadgeSetPrimaryMutation = typedMutation<Types.BadgeSetPrimary, Types.BadgeSetPrimaryVariables>(Badges.BadgeSetPrimaryMutation);
export const BadgeUnsetPrimaryMutation = typedMutation<Types.BadgeUnsetPrimary, {}>(Badges.BadgeUnsetPrimaryMutation);
export const BadgeInRoomQuery = typedQuery<Types.BadgeInRoom, Types.BadgeInRoomVariables>(Badges.BadgeInRoomQuery);
export const SuperBadgeCreateMutation = typedMutation<Types.SuperBadgeCreate, Types.SuperBadgeCreateVariables>(Badges.SuperBadgeCreateMutation);
...
export const SuperBadgeSetToRoomMutation = typedMutation<Types.SuperBadgeSetToRoom, Types.SuperBadgeSetToRoomVariables>(Badges.SuperBadgeSetToRoomMutation);
...
export const SuperBadgeDeleteMutation = typedMutation<Types.SuperBadgeDelete, Types.SuperBadgeDeleteVariables>(Badges.SuperBadgeDeleteMutation);
export const SuperBadgeVerifyMutation = typedMutation<Types.SuperBadgeVerify, Types.SuperBadgeVerifyVariables>(Badges.SuperBadgeVerifyMutation);
export const SuperBadgeUnverifyMutation = typedMutation<Types.SuperBadgeUnverify, Types.SuperBadgeUnverifyVariables>(Badges.SuperBadgeUnverifyMutation);
...
export const ReadNotificationMutation = typedMutation<Types.ReadNotification, Types.ReadNotificationVariables>(Comments.ReadNotificationMutation);
