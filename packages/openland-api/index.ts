...
export const BuyProChatSubscriptionMutation = typedMutation<Types.BuyProChatSubscription, Types.BuyProChatSubscriptionVariables>(Chats.BuyProChatSubscriptionMutation);
...
export const PaymentIntentCommitMutation = typedMutation<Types.PaymentIntentCommit, Types.PaymentIntentCommitVariables>(Finance.PaymentIntentCommitMutation);
export const PaymentIntentCancelMutation = typedMutation<Types.PaymentIntentCancel, Types.PaymentIntentCancelVariables>(Finance.PaymentIntentCancelMutation);
export const DonateMutation = typedMutation<Types.Donate, Types.DonateVariables>(Finance.DonateMutation);
export const MyWalletQuery = typedQuery<Types.MyWallet, {}>(Finance.MyWalletQuery);
export const WalletUpdatesSubscription = typedSubscription<Types.WalletUpdates, Types.WalletUpdatesVariables>(Finance.WalletUpdatesSubscription);
...
export const StickerPackRemoveFromCollectionMutation = typedMutation<Types.StickerPackRemoveFromCollection, Types.StickerPackRemoveFromCollectionVariables>(Stickers.StickerPackRemoveFromCollectionMutation);
...
export const UserPicoQuery = typedQuery<Types.UserPico, Types.UserPicoVariables>(User.UserPicoQuery);
...
export const WalletTransactionFragmentFragment = typedFragment<Types.WalletTransactionFragment>(Finance.WalletTransactionFragment);
export const WalletUpdateFragmentFragment = typedFragment<Types.WalletUpdateFragment>(Finance.WalletUpdateFragment);
