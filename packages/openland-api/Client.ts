...
export const Operations: { [key: string]: OperationDefinition } = {
    ...
    OrganizationPublicRooms: {
        ...
        body: 'query OrganizationPublicRooms($after:ID,$first:Int!,$organizationId:ID!){organizationPublicRooms(after:$after,first:$first,id:$organizationId){__typename cursor items{__typename ...SharedRoomView}}}fragment SharedRoomView on SharedRoom{__typename id membersCount photo title}',
