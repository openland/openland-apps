...
const RoomFullSelector = obj(
            ...
            inline('SharedRoom', obj(
                ...
                field('id', 'id', args(), notNull(scalar('ID'))),
                field('isChannel', 'isChannel', args(), notNull(scalar('Boolean'))),
                field('isPro', 'isPro', args(), notNull(scalar('Boolean'))),
                field('kind', 'kind', args(), notNull(scalar('String'))),
                field('matchmaking', 'matchmaking', args(), obj(
                        field('__typename', '__typename', args(), notNull(scalar('String'))),
                        fragment('MatchmakingRoom', MatchmakingRoomFragmentSelector)
                ...
                field('proPassIsActive', 'proPassIsActive', args(), notNull(scalar('Boolean'))),
                field('proSettings', 'proSettings', args(), obj(
                        field('__typename', '__typename', args(), notNull(scalar('String'))),
                        field('id', 'id', args(), notNull(scalar('ID'))),
...
const BuyProChatSubscriptionSelector = obj(
            field('betaBuyProChatSubscription', 'betaBuyProChatSubscription', args(fieldValue("chatId", refValue('chatId'))), notNull(scalar('Boolean')))
        );
...
export const Operations: { [key: string]: OperationDefinition } = {
    ...
    BuyProChatSubscription: {
        kind: 'mutation',
        name: 'BuyProChatSubscription',
        body: 'mutation BuyProChatSubscription($chatId:ID!){betaBuyProChatSubscription(chatId:$chatId)}',
        selector: BuyProChatSubscriptionSelector
    },
    CommentSetReaction: {
        kind: 'mutation',
