...
class EntriesComponentInner extends React.Component<EntriesComponentProps & { isMobile: boolean }> {
    containerRef?: any;
    targetRef?: any;
    ...
    render() {
        let maxHeight = this.props.inCompose ? 447 : 264;
...
const EntriesComponent = React.memo<EntriesComponentProps>(props => {
