        ...
        >
            <g id="Group-48" transform="translate(31.000000, 23.000000)">
                <linearGradient
                    ...
                    x2="19.6738"
                    y2="87.5638"
                    gradientTransform="matrix(122.5624 0 0 -146.5925 -2399.5908 12951.3506)"
                >
                ...
                <path
                    ...
                    d="M96,59.7L73.2,31.9l37.1-43.3c-2.5-1.9-5.1-3.7-7.8-5.4L62.3,7.6c-1.5-0.3-3-0.6-4.4-0.8 c-4.7-0.7-8.5-0.5-8.5-0.5c-30.8,0-56.4,22.6-61.1,52.1c-0.5,3.1-0.8,6.4-0.8,9.6c0,16.9,6.8,32.2,17.8,43.4 c11.2,11.4,26.8,18.4,44,18.4c12.5,0.2,23.7-4.7,23.7-4.7s-5.6-3.3-10.3-6.9c-2.2-1.7-5.8-4.9-7.5-7c-4.8-5.8-7.5-13.3-7.5-20.9 c0-4.3,0.8-8.6,2.5-12.6l0,0l25.3,7.9l0.5,0.2c4.5,1.7,9.4,1.4,13.7-0.7c1.5-0.7,2.9-1.7,4.1-2.9c4.4-4.3,6.2-10.4,4.8-16.3 C98.3,63.6,97.3,61.6,96,59.7"
                />
                <path
                    fill="#FFFFFE"
                    d="M29.1,39.5c0.1-0.1,0.2-0.2,0.3-0.3c0,0,0,0,0,0C29.2,39.3,29.1,39.4,29.1,39.5"
                />
                <path
                    fill="#FFFFFE"
                    d="M90.5,63.8l-0.4-0.5L64.2,31.8L95.3-4.5L53.7,20.9l2.3-7.4c-2.8-0.6-6.3-0.3-6.4-0.3 c-30.4,0-55,24.6-55,54.9s24.6,54.9,55,54.9c0.4,0,0.9,0,1.3,0c1.6,0,3.1-0.1,4.7-0.3c0.3,0,0.5-0.1,0.8-0.1 c-8.7-2.8-16.5-7.8-22.6-14.3c-0.9-1-1.8-2-2.7-3.1c-3-3.8-5.5-7.9-7.5-12.4c-2.7-6.4-4.3-13.5-4.3-20.9v-1.2 c0-11.7,3.8-22.5,10.1-31.2c-0.1,0.1-0.2,0.2-0.3,0.3c0.1-0.1,0.2-0.2,0.3-0.3c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0 c0.2-0.2,0.4-0.5,0.7-0.7c0,0,0,0,0,0c0,0,0.1,0,0.1-0.1c0,0,0,0,0,0c-0.1,0.2-0.2,0.4-0.3,0.7c-1.3,3.7-5.6,20.6,12.9,28.7 c5.9,2.6,13.3,4,19.5,6.1L78,79.2l0.5,0.2c2.7,1,5.6,0.9,8.3-0.5c0.9-0.4,1.7-1,2.4-1.7c2.7-2.7,3.8-6.3,2.9-9.8 C91.8,66.1,91.3,64.9,90.5,63.8"
                />
                <path
                    fill="#D1DAE6"
                    d="M30,38.5C30,38.5,30,38.5,30,38.5c-0.2,0.2-0.5,0.4-0.7,0.7c0,0,0,0,0,0 C23,48,19.2,58.8,19.2,70.5v1.2c0,7.4,1.5,14.5,4.3,20.9c1.9,4.5,4.4,8.7,7.5,12.4c0.9,1.1,1.8,2.1,2.7,3.1 c6.1,6.5,13.9,11.5,22.6,14.3c0.4,0,0.7-0.1,1.1-0.1c-2.7-2-5.1-4.2-7.3-6.9c-5.8-7.1-9.1-16-9.1-25.2c0-5.2,1-10.4,3-15.2 c-27.3-8.4-19-31.8-13.9-36.7C30.1,38.4,30.1,38.4,30,38.5C30.1,38.5,30.1,38.5,30,38.5"
                />
                <path
                    fill="#D1DAE6"
                    d="M29.3,39.2C29.3,39.2,29.3,39.2,29.3,39.2C29.3,39.2,29.4,39.2,29.3,39.2 C29.4,39.2,29.3,39.2,29.3,39.2"
                />
                <path
                    fill="#D1DAE6"
                    d="M33.7,108.2c-0.9-1-1.8-2-2.7-3.1C31.8,106.1,32.7,107.2,33.7,108.2"
                />
                <path
                    fill="#D1DAE6"
                    d="M30.1,38.4C30.1,38.5,30.1,38.5,30.1,38.4C30,38.5,30,38.5,30.1,38.4C30,38.5,30,38.5,30.1,38.4 C30.1,38.5,30.1,38.5,30.1,38.4"
                />
                <path
                    fill="#D1DAE6"
                    d="M33.7,108.2c6.1,6.5,13.9,11.5,22.6,14.3C47.5,119.7,39.8,114.7,33.7,108.2"
                />
                <path
                    fill="#D1DAE6"
                    d="M30.1,38.4C30.1,38.4,30.1,38.4,30.1,38.4C30.1,38.4,30.1,38.4,30.1,38.4"
                />
                <path
                    fill="#8A7CB7"
                    d="M52.8,36.5c-3-0.7-6.6,0.6-7.7,4.4L45,41.2l0.4,0c4.4-0.3,8.2,0.9,11.9,3.5l0.3,0.2l0.1-0.4 C58.5,40,55.8,37.2,52.8,36.5"
                />
            </g>
        </svg>
    </div>
