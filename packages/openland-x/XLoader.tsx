...
export const XLoader = (props: XLoaderProps) => {
    ...
    return <div className={cx(base, props.loading !== false ? displayFlex : displayNone, props.size === 'small' ? minHeightSmall : minHeightMedium, props.transparentBackground ? undefined : backgroundColor)}>
        {!canvas && <SvgLoader size={props.size || 'medium'} color={props.color || '#C4C7CC'} />}
        {canvas && <CanvasLoader size={props.size || 'medium'} color={props.color || '#C4C7CC'} />}
    </div>;
};
