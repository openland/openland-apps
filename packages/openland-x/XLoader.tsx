    ...
    <div className={splashWrapper}>
        <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#SplashClip)">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M53.4375 32.8125C51.1723 32.435 49.3125 33.5625 48.75 35.8125C51.75 35.4375 54.6562 36.5625 56.5312 38.0625C57.0937 35.4375 55.6875 33.1875 53.4375 32.8125Z" fill="#7373BF" />
            </g>
            <defs>
