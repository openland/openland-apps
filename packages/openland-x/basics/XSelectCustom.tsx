    ...
    props => ({
        ...
        '&:focus-within': {
            boxShadow: `0 0 0 2px rgba${
                props.rounded ? '(23, 144, 255, 0.2)' : '(143, 124, 246, 0.2)'
            }`,
...
export class XSelectCustomInputRender extends React.Component<
    XSelectCustomProps,
    XSelectCustomState
> {
    input?: any;
...
export class XSelectCustomUsersRender extends React.Component<
    XSelectCustomProps & { inCompose?: boolean },
    XSelectCustomState
> {
    input?: any;
    constructor(props: XSelectCustomProps & { inCompose?: boolean }) {
        super(props);
    ...
    componentWillReceiveProps(props: XSelectCustomProps & { inCompose?: boolean }) {
        if (
