...
import { MatchmakingProfileFragment } from 'openland-web/fragments/matchmaking/MatchmakingProfileFragment';
...
routing.addRoute('/matchmaking/:roomId/created', () => MatchmakingProfileFragment);
