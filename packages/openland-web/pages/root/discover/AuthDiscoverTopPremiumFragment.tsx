...
const AuthDiscoverTopPremiumInner = React.memo(() => {
...
export const AuthDiscoverTopPremiumFragment = React.memo(() => {
    return (
        <AuthDiscoverContainer title="Top premium" showBack={true}>
            <AuthDiscoverTopPremiumInner />
