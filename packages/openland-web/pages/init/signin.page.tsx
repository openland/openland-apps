            ...
            >
                ...
                {this.state.email && !this.state.emailSent && (
                    <div style={{ position: 'relative' }}>
                        ...
                        <ButtonsWrapper marginTop={40} width={280}>
                            <XInput autofocus={true} size="r-default" color="primary-sky-blue" onChange={this.emailChanged} value={this.state.emailValue} placeholder={InitTexts.auth.emailPlaceholder} onEnter={this.loginEmailStart} />
                        </ButtonsWrapper>
                        <ButtonsWrapper marginTop={20} marginBottom={84} width={280}>
                            <XHorizontal>
                                <XButton onClick={this.loginReset} style="ghost" size="r-default" alignSelf="stretch" flexGrow={1} text={InitTexts.auth.reset} />
                                <XButton onClick={this.loginEmailStart} style="primary-sky-blue" size="r-default" alignSelf="stretch" flexGrow={1} loading={this.state.emailSending} text={InitTexts.auth.next} />
                            </XHorizontal>
                        </ButtonsWrapper>
                    </div>
                )}
                ...
                {this.state.emailSent && (
                    <div style={{ position: 'relative' }}>
                        ...
                        <ButtonsWrapper marginTop={40} width={280}>
                            <XInput autofocus={true} size="r-default" color="primary-sky-blue" onChange={this.codeChanged} value={this.state.codeValue} placeholder={InitTexts.auth.codePlaceholder} onEnter={this.loginCodeStart} />
                        </ButtonsWrapper>
                        <ButtonsWrapper marginTop={20} marginBottom={84} width={280}>
                            <XHorizontal>
                                <XButton onClick={this.loginReset} size="r-default" style="ghost" alignSelf="stretch" flexGrow={1} text={InitTexts.auth.reset} />
                                <XButton onClick={this.loginCodeStart} size="r-default" style="primary-sky-blue" alignSelf="stretch" flexGrow={1} loading={this.state.codeSending} text={InitTexts.auth.complete} />
                            </XHorizontal>
                        </ButtonsWrapper>
                    </div>
                )}
