            ...
            <XVertical separator={36}>
                ...
                <XVertical separator={12}>
                    <XHorizontal separator={5}>
                        <XAvatar size="medium" cloudImageUuid={props.data.invite.creator.picture || undefined} style={'colorus'} userName={props.data.invite.creator.name}  userId={props.data.invite.creator.id} />
