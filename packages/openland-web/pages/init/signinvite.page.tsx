            ...
            <XVertical separator={12}>
                <XHorizontal separator={5}>
                    ...
                    <BubbleMsg separator={3}>
                        ...
                        <XText
                            ...
                            color="#61707e"
                        >
                            {inviter.name + ' has invited you to join Openland'}
                        </XText>
                    </BubbleMsg>
                </XHorizontal>
                ...
                <XHorizontal separator={5}>
                    ...
                    <BubbleMsg separator={3}>
                        ...
                        >
                            <p>
                                Openland is a free messenger for real estate
                                professionals.
                            </p>
                            <p>
                                It’s a great way to discover and discuss new
                                opportunities,
                            </p>
                            <p>and share information about the market.</p>
                        </XText>
                    </BubbleMsg>
                </XHorizontal>
            ...
            <>
                ...
                <XTrack event="Invite">
                    <MessagePage>
                        <InviteInfo
                            variables={{
                                inviteKey: props.router.query.redirect.split(
                                    '/',
                                )[2],
                            }}
                            redirect={props.router.query.redirect}
                        />
                    </MessagePage>
                </XTrack>
            </>
