...
const Accept = withRoomAddMembers(props => {
    ...
    variables: { roomId: string; userId: string };
    isHovered: boolean;
}>;
            ...
            <MembersWrapper>
                {this.props.longDescription && (
                    <>
                        ...
                        {this.props.longDescription && (
                            <AboutText>{this.props.longDescription}</AboutText>
                        )}
                    </>
                )}
                {requests.length > 0 && (
                ...
                <RemoveMemberModal
                    ...
                    roomId={this.props.roomId}
                    roomTitle={this.props.channelTitle}
                />
            </MembersWrapper>
        );
    }
