...
declare module 'next-routes' {
    interface Routes {
        ...
        Router: {
            pushRoute(route: string, opts?: any): Promise<any>;
            replaceRoute(route: string, opts?: any): Promise<any>;
        };
    }
...
declare module 'find-with-regex' {
    const ReturnType: (unicodeRegex: RegExp, contentBlock: Object, callback: Function) => void;
    export default ReturnType;
}
