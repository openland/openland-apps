...
useJsDrag(selfRef, selfRef, props.mediaSession.volumeSpace.onSelfMoved, props.mediaSession.volumeSpace.getSelfCoords(), undefined, undefined, undefined, [props.peers]);
React.useEffect(() => {
