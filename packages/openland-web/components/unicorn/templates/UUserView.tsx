...
import { UserShort, OrganizationMemberRole, RoomMemberRole } from 'openland-api/spacex.types';
...
export const UUserView = React.memo((props: UUserViewProps & Partial<UListItemProps>) => {
    const { user, role, onClick, savedMessages, ...other } = props;
    ...
    return (
        <UListItem
            ...
            description={savedMessages ? undefined : <UPresence user={props.user} />}
