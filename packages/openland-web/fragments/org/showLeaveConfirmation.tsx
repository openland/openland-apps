...
import { OrganizationWithoutMembers } from 'openland-api/spacex.types';
import { MessengerEngine } from 'openland-engines/MessengerEngine';

export const showLeaveConfirmation = (organization: OrganizationWithoutMembers['organization'], messenger: MessengerEngine, onLeave: (id: string) => void) => {
