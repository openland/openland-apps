    ...
    componentWillReceiveProps(nextProps: MessagePageProps) {
        ...
        if (
            ...
            let target = {
                editMessageId: null,
                editMessage: null,
                forwardMessagesId: new Set<string>(),
                selectedMessages: new Set<DataSourceMessageItem>(),
                replyMessagesId: new Set<string>(),
                replyMessages: new Set<string>(),
                replyMessagesSender: new Set<string>(),
                useForwardMessages: false,
                useForwardPlaceholder: false,
                useForwardHeader: false,
            };
