...
const ProgressLoader = (props: ProgressLoader) => {
    ...
    return (
        <div
            className={progressLoaderWrapper}
            style={
                {
                    '--progress-wrapper': `${wrapperSize}px`,
                    '--dashArray': c,
        ...
        >
            ...
            >
                <circle
                    className={progressLoaderCircle}
                    cx={radius + 1}
                    cy={radius + 1}
                    r={radius}
                />
...
export const MediaLoader = React.memo(React.forwardRef(
    (props: MediaLoaderProps, ref: React.Ref<HTMLDivElement>) => {
        ...
        return (
            <div
                ...
                ref={ref}
                onClick={cancelable ? handleClick : undefined}
                style={
                    {
