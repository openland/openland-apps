...
const MemberJoinedCard = (props: MemberJoinedProps) => {
    ...
    return <XUserCard user={user} hideOrganization={true} role={role} customMenu={customMenu} />;
};
                            ...
                            content={
                                <>
                                    ...
                                    <XWithRole role={['editor', 'super-admin']}>
                                        <XMenuItem
                                            path={'/super/orgs/' + organization.superAccountId}
                                        >
...
export const CreateGroupPopperButton = XMemo((props: { orgId: string }) => {
    ...
    return (
        <XPolitePopper
            ...
            content={
                <>
                    <XMenuItem path={'/mail/create?org=' + props.orgId}>New group</XMenuItem>
                    <XMenuItem path={'/mail/create?orgchannel=' + props.orgId}>
                        New channel
                    </XMenuItem>
                </>
            }
