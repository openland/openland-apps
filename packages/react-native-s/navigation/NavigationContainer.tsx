...
export class NavigationContainer extends React.PureComponent<NavigationContainerProps, NavigationContainerState> implements NavigationManagerListener {
    ...
    render() {
        ...
        return (
            <View style={[styles.fill, Platform.OS === 'android' && { paddingTop: contentInset }]} {...Platform.OS === 'ios' ? this.panResponder.panHandlers : undefined}>
                <ASSafeAreaProvider
                    top={Platform.OS === 'android' ? 0 : contentInset}
