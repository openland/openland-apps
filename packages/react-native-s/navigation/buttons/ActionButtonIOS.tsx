...
export class ActionButtonIOS extends React.PureComponent<{ title: string, icon?: any, onPress?: () => void }> {
    render() {
        return (
            <TouchableOpacity onPress={this.props.onPress} hitSlop={{ bottom: 8, top: 8, left: 8, right: 8 }}>
                <View style={{ height: 44, marginLeft: 10, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {this.props.icon && <Image source={this.props.icon} style={{ width: 22, height: 22 }} resizeMode="center" />}
                </View>
            </TouchableOpacity>
        );
    }
