...
const NEW_IPADAIR_HEIGHT = 1180;
const NEW_IPADAIR_WIDTH = 820;
...
const isNewIPadPro = (() => {
    ...
    return (
        ...
        (D_HEIGHT === NEW_IPADAIR_HEIGHT && D_WIDTH === NEW_IPADAIR_WIDTH) ||
        (D_HEIGHT === NEW_IPADAIR_WIDTH && D_WIDTH === NEW_IPADAIR_HEIGHT)
    );
})();
