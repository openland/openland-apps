...
const LeftIcon = (props: { theme: ThemeGlobal, src: any, flatIcon?: boolean, appearance?: 'default' | 'action' | 'danger', leftIconColor?: string }) => {
    ...
    return (
        <View style={{ width: 40, height: 40, borderRadius: 20, alignContent: 'center', justifyContent: 'center', backgroundColor: leftIconColor || (appearance === 'danger' ? theme.accentNegative : theme.tint5), marginLeft: 16, alignSelf: 'center' }}>
            <Image source={src} resizeMode="contain" style={{ width: 24, height: 24, alignSelf: 'center', tintColor: theme.contrastPrimary }} />
        </View>
    );
};
