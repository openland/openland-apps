...
export type LocalizationSchema = {
    ...
    "isTyping": string,
    "isPickingASticker": string,
    "isSendingAFile": string,
    "isSendingAPhoto": string,
    "isUploadingAVideo": string,
    "areTyping": string,
    "arePickingASticker": string,
    "areSendingAFile": string,
    "areSendingAPhoto": string,
    "areUploadingAVideo": string,
    "join": string,
    "joinAll": string,
    "joinChannel": string,
    "joinChat": string,
    ...
    "notifyAllInThisGroup": string,
    "notifyAllInThisChannel": string,
    "off": string,
    "on": string,
    "online": string,
    "open": string,
    ...
    "serviceYouWereKicked": string,
    "serviceJoinedOpenland": string,
    "settings": string,
    "share": string,
