                            ...
                            {resp => {
                                return (
                                    ...
                                    >
                                        ...
                                        <ZListItemGroup header="Email frequency" footer={'When you’re busy or not online, Openland can send you email notifications about new messages. We will use ' + resp.data.settings.primaryEmail + ' for notifications'}>
