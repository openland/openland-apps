    ...
    return (
        <View style={styles.post}>
            <View style={styles.header}>
                ...
                <Text style={{ ...TextStyles.Subhead, marginLeft: 12, color: theme.foregroundSecondary }}>
                    {sender.name}
                </Text>
                {sender.primaryOrganization && (
                    <>
                        <View style={[styles.dotDivider, { backgroundColor: theme.foregroundSecondary }]} />
                        <Text style={{ ...TextStyles.Subhead, color: theme.foregroundSecondary, flex: 1 }} numberOfLines={1} ellipsizeMode={'tail'}>
            ...
            <Text style={{ ...TextStyles.Body, color: theme.foregroundPrimary, paddingBottom: 4 }}>
                {post.message}
            </Text>
