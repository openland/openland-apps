    ...
    <>
        ...
        <ASSafeAreaView flexGrow={1} paddingHorizontal={16}>
            <View height="73%" alignItems="center" justifyContent="center">
                ...
                <Text style={{ textAlign: 'center', fontSize: 22, lineHeight: 28, color: props.theme.foregroundPrimary, marginBottom: 10, fontWeight: TextStyles.weight.medium }} allowFontScaling={false}>Cannot view group</Text>
