    ...
    render() {
        return (
            <View flexBasis={0} flexGrow={1}>
                <Image source={require('assets/img-chat-3.jpg')} style={{ position: 'absolute', left: 0, top: 0, width: Dimensions.get('window').width, height: Dimensions.get('window').height }} resizeMode="repeat" />
