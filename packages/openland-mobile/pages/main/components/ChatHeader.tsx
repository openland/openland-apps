    ...
    return (
        <View flexDirection="column" alignItems="flex-start" alignSelf="center" justifyContent="center" pointerEvents="box-none" height={44} minWidth={0} flexBasis={0} flexShrink={1} flexGrow={1}>
            <View flexDirection="row">
                {room.kind === 'GROUP' && (<View height={18} alignItems="center" justifyContent="center" marginRight={2}><Image opacity={CompensationAlpha} source={require('assets/ic-lock-16.png')} style={{ tintColor: theme.accentPositive, marginTop: 3 }} /></View>)}
