                ...
                <SFlatList
                    ...
                    renderItem={({ item }) => (
                        <ZListItem
                            ...
                            subTitle={<>{item.membersCount + (item.membersCount === 1 ? ' member' : ' members')}<Text style={{ opacity: 0.5 }}> ∙</Text> {item.betaPublicRoomsCount + (item.betaPublicRoomsCount === 1 ? ' chat' : ' chats')}</>}
