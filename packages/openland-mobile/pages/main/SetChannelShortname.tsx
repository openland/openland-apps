...
const SetChannelShortnameComponent = XMemo<PageProps>((props) => {
    // const { router } = props;
    // const { id } = router.params;
    // const profile = getClient().useOrganizationProfile({ id }, { fetchPolicy: 'network-only' }).organizationProfile;
    ...
    const handleSave = () => {
        ...
        //             await getClient().mutateSetChannelShortname({
...
export const SetChannelShortname = withApp(SetChannelShortnameComponent, { navigationAppearance: 'small' });
