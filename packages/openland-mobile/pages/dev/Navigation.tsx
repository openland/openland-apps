            ...
            <ZScrollView>
                <View style={{ flexDirection: 'column' }}>
                    <ZListItemGroup header="Android">
                        <ZHeaderTitle index={0} appearance="android" titleText="Messages" progress={this.offsetVal} hairlineOffset={new Animated.Value(56)} />
                        <ZHeaderTitle index={1} appearance="android" titleText="Justin Bieber" subtitleText="Person" progress={this.offsetVal} hairlineOffset={new Animated.Value(56)} />
                        <View height={106}>
                            <ZHeaderTitle index={0} appearance="android" titleText="Justin Bieber" subtitleText="Person" progress={this.offsetVal} hairlineOffset={this.size} />
                        </View>
                    </ZListItemGroup>
                    <ZListItemGroup header="iOS">
                        <ZHeaderTitle index={0} appearance="ios" titleText="Messages" progress={this.offsetVal} hairlineOffset={new Animated.Value(56)} />
                        <ZHeaderTitle index={1} appearance="ios" titleText="Messages" progress={this.offsetVal} hairlineOffset={new Animated.Value(56)} />
                        <ZHeaderTitle index={0} appearance="ios" titleText={'!'.repeat(this.state.size)} progress={new Animated.Value(0)} hairlineOffset={new Animated.Value(56)} />
                    </ZListItemGroup>
