...
const MatchmakingProfileComponent = React.memo((props: PageProps) => {
    ...
    let profile = client.useMatchmakingProfile(
        { peerId: props.router.params.peerId, uid: props.router.params.userId },
            ...
            <SScrollView>
                ...
                {answers.map(a => (
                    <ZListItem
                        ...
                        text={
                            a.__typename === 'TextMatchmakingAnswer'
                                ? a.answer
                                : a.__typename === 'MultiselectMatchmakingAnswer'
                                    ? a.tags.join(', ')
                                    : ''
                        }
                    />
