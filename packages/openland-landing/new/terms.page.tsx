...
export const TermsPage = React.memo(() => (
    <Page>
        ...
        <Hero
            title="Terms of Service @ Openland"
            subtitle="Effective Date — July 9, 2018"
            image={{
                link: '/static/landing/terms.png',
                width: 230,
                height: 182
            }}
        />
        ...
        <Container>
            <Content contents={SectionsList}>
                ...
                <p>
                    ...
                    Openland&rsquo;s provision of&nbsp;the Service to&nbsp;you, constitutes
                    an&nbsp;agreement by&nbsp;Openland and by&nbsp;you (on&nbsp;behalf
                    of&nbsp;yourself or&nbsp;the entity that you represent) to&nbsp;be&nbsp;bound
                    by&nbsp;these Terms. Your use of&nbsp;Service also represents and warrants that
                ...
                <p>
                    ...
                    (a) is&nbsp;a&nbsp;legal entity or&nbsp;an&nbsp;individual who is&nbsp;capable
                    of&nbsp;forming legally binding agreements under applicable law; (b) you have
                    not previously been suspended or&nbsp;removed from the Service; and
                    &copy;&nbsp;your registration and your use of&nbsp;the Service
                ...
                <p>
                    ...
                    an&nbsp;account (or&nbsp;permit Openland to&nbsp;register an&nbsp;account
                    on&nbsp;your behalf). When you register for an&nbsp;account, you may
                    be&nbsp;required to&nbsp;provide&nbsp;us with some information about yourself,
                    such as&nbsp;your name, email address, and mobile number. You agree that the
                    information you provide to&nbsp;us is&nbsp;accurate and that you will keep
                    it&nbsp;accurate and up-to-date at&nbsp;all times.
                </p>
                <p>
                    When you register, you may be&nbsp;asked to&nbsp;provide a&nbsp;password. You
                    ...
                    breach of&nbsp;security. Openland cannot and will not be&nbsp;liable for any
                    loss or&nbsp;damage arising from your failure to&nbsp;comply with the above
                    requirements. If&nbsp;you believe that your account is&nbsp;no&nbsp;longer
                ...
                <p>
                    &ldquo;User Content&rdquo; means any and all information and content that
                    a&nbsp;user submits&nbsp;to, or&nbsp;uses with, the Site (e.&nbsp;g., content
                    in&nbsp;the user&rsquo;s profile or&nbsp;postings). You are solely responsible
                    ...
                    Content that personally identifies you or&nbsp;any third party. You may not
                    ...
                    Content may be&nbsp;deleted at&nbsp;any time without prior notice. You are
                    solely responsible for creating and maintaining your own backup copies
                    of&nbsp;your User Content if&nbsp;you desire.
                </p>
                <p>
                    You represent and warrant that you have and will maintain all rights necessary
                    to&nbsp;grant to&nbsp;Openland the rights granted in&nbsp;these Terms, and
                    by&nbsp;providing your User Content to&nbsp;Openland in&nbsp;accordance with the
                    Terms, you will not violate any Intellectual Property Rights of&nbsp;third
                    parties, confidential relationships, contractual obligations or&nbsp;laws.
                </p>
                <p>
                    You hereby grant (and you represent and warrant that you have the right
                    to&nbsp;grant) to&nbsp;Company an&nbsp;irrevocable, nonexclusive, royalty-free
                    ...
                    of&nbsp;including your User Content in&nbsp;the Site. You hereby irrevocably
                    waive (and agree to&nbsp;cause to&nbsp;be&nbsp;waived) any claims and assertions
                    of&nbsp;moral rights or&nbsp;attribution with respect to&nbsp;your User Content.
                </p>
                <h2 id="section6">Marketing</h2>
                <p>
                    Unless explicitly granted an&nbsp;exception, you agree to&nbsp;allow Openland
                    to&nbsp;use and display your organization&rsquo;s logo and name on&nbsp;our
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Openland employee, any other person, or&nbsp;entity.
                    </li>
                    <li>
                        To&nbsp;engage in&nbsp;any other conduct that restricts or&nbsp;inhibits
                        anyone&rsquo;s use or&nbsp;enjoyment of&nbsp;the Service, or&nbsp;which,
                        as&nbsp;determined by&nbsp;us, may harm or&nbsp;offend the Company
                ...
                <ul>
                    <li>
                        Use the Service in&nbsp;any manner that could disable, overburden, damage,
                        or&nbsp;impair the Service or&nbsp;interfere with any other party&rsquo;s
                        use of&nbsp;the Service.
                    </li>
                    <li>
                ...
                <p>
                    Openland retains the property rights over its pre-existing works (including the
                    Intellectual Property Rights), as&nbsp;well as&nbsp;of&nbsp;all or&nbsp;part
                    of&nbsp;its materials, information, tools, methods, systems, equipment, hardware
                    and software, documentation, data, databases, files of&nbsp;all types, made
                    available to&nbsp;you and your entity within the framework of&nbsp;this
                    Agreement. Consequently, Customer will only have a&nbsp;right of&nbsp;access
                    strictly limited to&nbsp;their individual or&nbsp;organizational use of&nbsp;the
                    Service.
                </p>
                <p>
                    For the avoidance of&nbsp;doubt, except as&nbsp;expressly provided in&nbsp;this
                    Agreement, your access and use to&nbsp;the Services does not convey any rights
                    (including Intellectual Property Rights) or&nbsp;ownership, either express
                    or&nbsp;implied, in&nbsp;all or&nbsp;part&nbsp;of (a) the services; (b) the
                    software; &copy;&nbsp;the site; or&nbsp;(d) any related documentation.
                </p>
                <h2 id="section9">No support obligations</h2>
                <p>
                    We&nbsp;are under no&nbsp;obligation to&nbsp;provide support for the Service.
                    In&nbsp;instances where we&nbsp;may offer support, the support will
                    be&nbsp;subject to&nbsp;published policies.
                </p>
                <h2 id="section10">Links</h2>
                <p>
                    Openland has not reviewed all of&nbsp;the sites linked to&nbsp;its website and
                    is&nbsp;not responsible for the contents of&nbsp;any such linked site. The
                    inclusion of&nbsp;any link does not imply endorsement by&nbsp;Openland
                ...
                <p>
                    ...
                    or&nbsp;available for use outside of&nbsp;the United States. You agree that you
                    will not use the Service in&nbsp;any country or&nbsp;in&nbsp;any manner
                ...
                <ul>
                    <li>
                        Take any action with respect to&nbsp;any user that we&nbsp;deem necessary
                        or&nbsp;appropriate in&nbsp;our sole discretion, including
                        if&nbsp;we&nbsp;believe that such user violates the Terms, infringes any
                    ...
                    <li>
                        ...
                        including their intellectual property rights or&nbsp;their right
                        to&nbsp;privacy.
                    </li>
                    <li>
                        Take appropriate legal action, including without limitation, referral
                        to&nbsp;law enforcement, for any illegal or&nbsp;unauthorized use
                        of&nbsp;the Service.
                    </li>
                    <li>
                ...
                <p>
                    ...
                    or&nbsp;directing&nbsp;us to&nbsp;disclose the identity or&nbsp;other
                    information of&nbsp;anyone posting any materials on&nbsp;or&nbsp;through the
                    Service. You waive and hold harmless the Company and its affiliates, licensees,
                    and service providers from any claims resulting from any action taken
                    by&nbsp;any of&nbsp;the foregoing parties during or&nbsp;as&nbsp;a&nbsp;result
                ...
                <p>
                    ...
                    it&nbsp;is&nbsp;posted on&nbsp;the Service, and cannot ensure prompt removal
                    ...
                    or&nbsp;third party. We&nbsp;have no&nbsp;liability or&nbsp;responsibility
                    to&nbsp;anyone for performance or&nbsp;nonperformance of&nbsp;the activities
                    described in&nbsp;this section.
                </p>
                <h2 id="section13">Disclaimer of&nbsp;warranties</h2>
                <p>
                    YOUR USE OF&nbsp;THE SERVICE IS&nbsp;AT&nbsp;YOUR OWN RISK. THE SITE, ITS
                    CONTENT, AND ANY ITEMS OBTAINED THROUGH OPENLAND SERVICES ARE PROVIDED
                    ...
                    THE COMPANY REPRESENTS OR&nbsp;WARRANTS THAT THE SERVICES, ITS CONTENT,
                ...
                <p>
                    ...
                    FOR PARTICULAR PURPOSE. THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH
                    CANNOT BE&nbsp;EXCLUDED OR&nbsp;LIMITED UNDER APPLICABLE LAW.
                </p>
                <h2 id="section14">Limitation of&nbsp;liability</h2>
                <p>
                    TO&nbsp;THE MAXIMUM EXTENT PERMITTED BY&nbsp;APPLICABLE LAW, OPENLAND
                    WILL&nbsp;IN NO&nbsp;EVENT BE&nbsp;LIABLE FOR ANY INDIRECT DAMAGES, INCLUDING
                    BUT NOT LIMITED TO&nbsp;LOSS OF&nbsp;DATA OR&nbsp;CONTENT, LOSS OF&nbsp;PROFITS,
                    OR&nbsp;OTHER SPECIAL, INCIDENTAL, CONSEQUENTIAL, EXEMPLARY OR&nbsp;RELIANCE
                    DAMAGES ARISING FROM OR&nbsp;IN&nbsp;RELATION TO&nbsp;THE TERMS OR&nbsp;THE
                    SERVICES, HOWEVER CAUSED.
                </p>
                <p>
                    IN&nbsp;NO&nbsp;EVENT WILL&nbsp;OPENLAND&rsquo;S LIABILITY HEREUNDER EXCEEDS THE
                    AMOUNT OF&nbsp;FEES EFFECTIVELY PAID&nbsp;BY CUSTOMER TO&nbsp;OPENLAND UNDER THE
                    PAID-PLAN CONCERNED FOR THE TWELVE-MONTH PERIOD PRECEDING SUCH CLAIM.
                </p>
                <p>
                    IN&nbsp;ADDITION, TO&nbsp;THE MAXIMUM EXTENT PERMITTED BY&nbsp;APPLICABLE LAW,
                    OPENLAND SHALL&nbsp;HAVE NO&nbsp;LIABILITY IN&nbsp;RESPECT OF, ANY AND
                    ALL&nbsp;CLAIMS FOR ANY DIRECT AND INDIRECT DAMAGES, FOR ANY REASON AND
                    ON&nbsp;ANY BASIS, ARISING FROM OR&nbsp;IN&nbsp;RELATION TO&nbsp;THE SERVICES
                    PROVIDED TO&nbsp;THE CUSTOMER IN&nbsp;THE COURSE
                    OF&nbsp;A&nbsp;NON-PAID&nbsp;PLAN OR&nbsp;DURING A&nbsp;TRIAL PERIOD.
                </p>
                ...
                <p>
                    ...
                    liabilities and expenses (including reasonable attorney&rsquo;s fees) relating
                    to&nbsp;or&nbsp;arising out of&nbsp;your use of&nbsp;or&nbsp;inability
                    to&nbsp;use the Site or&nbsp;services, your violation of&nbsp;any terms
                    of&nbsp;this Agreement or&nbsp;your violation of&nbsp;any rights
                    of&nbsp;a&nbsp;third party, or&nbsp;your violation of&nbsp;any applicable laws,
                    rules or&nbsp;regulations. The Company reserves the right, at&nbsp;its own cost,
                ...
                <p>
                    ...
                    unaffected and in&nbsp;full force and effect. The failure to&nbsp;enforce any
                    provision of&nbsp;these Terms is&nbsp;not a&nbsp;waiver of&nbsp;our right
                    to&nbsp;do&nbsp;so&nbsp;later, and no&nbsp;waiver shall be&nbsp;effective unless
                    made in&nbsp;writing and signed by&nbsp;an&nbsp;authorized representative
                    of&nbsp;the waiving party.
                </p>
                <h2 id="section17">Dispute resolution</h2>
                <p>
                    Most user concerns can be&nbsp;resolved quickly and to&nbsp;the user&rsquo;s
                    satisfaction by&nbsp;emailing our support team at{' '}
                    <a href="mailto:hello@openland.com">hello@openland.com</a>.
                </p>
                <p>
                    In&nbsp;the unlikely event that the Openland&rsquo;s support team is&nbsp;unable
                    to&nbsp;resolve your complaint, all matters relating to&nbsp;the Service and the
                    Terms and any dispute or&nbsp;claim arising therefrom or&nbsp;related thereto
                    (in&nbsp;each case, including non-contractual disputes or&nbsp;claims), shall
                ...
                <p>
                    At&nbsp;Company&rsquo;s sole discretion, it&nbsp;may require you to&nbsp;submit
                    ...
                    of&nbsp;the American Arbitration Association applying California law.
                </p>
                <p>
                    Any legal suit, action, or&nbsp;proceeding arising out&nbsp;of,
                    or&nbsp;related&nbsp;to, the Terms or&nbsp;the Service shall be&nbsp;instituted
                    exclusively in&nbsp;the federal courts of&nbsp;the United States or&nbsp;the
                    courts of&nbsp;the State of&nbsp;California in&nbsp;each case located
                    in&nbsp;the County and City of&nbsp;San Francisco. You waive any and all
                ...
                <p>
                    This agreement remains in&nbsp;full force and effect while you use the Service.
                    We&nbsp;may terminate your account at&nbsp;any time and for any reason.
                    If&nbsp;you wish to&nbsp;terminate your account, you may simply stop using the
                    Service, not renew your subscription, or&nbsp;contact&nbsp;us at{' '}
                    <a href="mailto:hello@openland.com">hello@openland.com</a>. All provisions
                    of&nbsp;the Terms shall survive termination by&nbsp;either party, including,
                ...
                <p>
                    Openland reserves the right to&nbsp;change these Terms from time to&nbsp;time.
                    Any changes to&nbsp;the Terms will become effective on&nbsp;the &ldquo;Effective
                    Date&rdquo; indicated above. If&nbsp;you continue to&nbsp;use the service after
                    those changes took effect, you consent to&nbsp;the new Policy. Openland will
                    always have the latest Terms posted on&nbsp;the Service.
                </p>
                <h2 id="section21">Contact&nbsp;us</h2>
                <p>
                    If&nbsp;you have comments or&nbsp;questions about our Terms of&nbsp;Service,
                    please reach out by&nbsp;email at{' '}
                    <a href="mailto:hello@openland.com">hello@openland.com</a> or&nbsp;send physical
