...
gsutil -m cp -r -n ./packages/openland-web/.next/bundles/pages/* "gs://cdn.openland.com/app/_next/${BUILD_ID}/page/"
gsutil -m cp -r -n ./packages/openland-web/.next/static/commons/main-* "gs://cdn.openland.com/app/_next/static/commons/"
gsutil -m cp -r -n ./packages/openland-web/.next/chunks/* "gs://cdn.openland.com/app/_next/webpack/chunks/"
