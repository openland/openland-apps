...
./node_modules/.bin/react-native bundle --platform ios --entry-file index.thread.js --bundle-output ./build/bundle-ios/index.thread.jsbundle --assets-dest ./build/bundle-ios/ --dev false
...
./node_modules/.bin/react-native bundle --platform android --entry-file index.thread.js --bundle-output ./build/bundle-android/index.thread.jsbundle --assets-dest ./build/bundle-android/ --dev false