...
./node_modules/.bin/appcenter codepush release -a ex3ndr/Openland-Android -d Staging --update-contents-path ./build/bundle-android -t $IOS_VERSION --description "CI Build: $1"