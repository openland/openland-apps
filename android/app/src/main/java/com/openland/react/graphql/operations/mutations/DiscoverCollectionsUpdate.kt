...
val DiscoverCollectionsUpdate = object: OperationDefinition {
    ...
    override val body = "mutation DiscoverCollectionsUpdate(\$id:ID!,\$title:String!,\$description:String,\$image:ImageRefInput!,\$chatIds:[ID!]!){discoverCollectionsUpdate(id:\$id,input:{title:\$title,description:\$description,image:\$image,chatIds:\$chatIds}){__typename id title}}"
