...
val conferenceAlterMediaState = object: OperationDefinition {
    ...
    override val body = "mutation conferenceAlterMediaState(\$id:ID!,\$settings:MediaStreamMediaStateInput!){conferenceAlterMediaState(id:\$id,settings:\$settings){__typename ...ConferenceShort}}fragment ConferenceShort on Conference{__typename id startTime iceServers{__typename urls username credential}}"
