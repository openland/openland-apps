...
val OrganizationPico = object: OperationDefinition {
    ...
    override val body = "query OrganizationPico(\$id:ID!){organization(id:\$id){__typename ...OrganizationShort}}fragment OrganizationShort on Organization{__typename id name photo shortname about isCommunity:alphaIsCommunity membersCount}"
