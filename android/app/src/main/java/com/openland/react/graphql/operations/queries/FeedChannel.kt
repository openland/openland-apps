...
val FeedChannel = object: OperationDefinition {
    ...
    override val body = "query FeedChannel(\$id:ID!){channel:alphaFeedChannel(id:\$id){__typename ...FeedChannelFull}}fragment FeedChannelFull on FeedChannel{__typename about id isGlobal myRole photo postsCount shortname socialImage subscribed subscribersCount title}"
