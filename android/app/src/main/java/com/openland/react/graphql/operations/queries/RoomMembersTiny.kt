...
val RoomMembersTiny = object: OperationDefinition {
    ...
    override val body = "query RoomMembersTiny(\$roomId:ID!){members:roomMembers(roomId:\$roomId){__typename user{__typename id name photo primaryOrganization{__typename id name}shortname}}}"
