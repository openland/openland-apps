...
val DiscoverCollectionsCreate = object: OperationDefinition {
    ...
    override val body = "mutation DiscoverCollectionsCreate(\$title:String!,\$image:ImageRefInput!,\$chatIds:[ID!]!){discoverCollectionsCreate(collection:{title:\$title,image:\$image,chatIds:\$chatIds}){__typename id title}}"
