...
val BuyPremiumChatSubscription = object: OperationDefinition {
    ...
    override val body = "mutation BuyPremiumChatSubscription(\$chatId:ID!){betaBuyPremiumChatSubscription(chatId:\$chatId){__typename id premiumPassIsActive premiumSubscription{__typename id state}}}"
