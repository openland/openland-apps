...
val DiscoverCollectionsShort = object: OperationDefinition {
    ...
    override val body = "query DiscoverCollectionsShort(\$first:Int!,\$after:String){discoverCollections(first:\$first,after:\$after){__typename items{__typename ...DiscoverChatsCollectionShort}cursor}}fragment DiscoverChatsCollectionShort on DiscoverChatsCollection{__typename id title shortname chatsCount description image{__typename uuid crop{__typename x y w h}}}"
