...
val OrganizationAddMember = object: OperationDefinition {
    ...
    override val body = "mutation OrganizationAddMember(\$userIds:[ID!],\$organizationId:ID!){alphaOrganizationMemberAdd(userIds:\$userIds,organizationId:\$organizationId){__typename role user{__typename ...UserShort}}}fragment UserShort on User{__typename ...UserSmall online lastSeen}fragment UserSmall on User{__typename id name firstName photo shortname isBot}"
