...
object Operations {
    ...
    val BetaSaveSelectedTags = object: OperationDefinition {
        ...
        override val kind = OperationKind.MUTATION
        override val body = "mutation BetaSaveSelectedTags(\$excudedGroupsIds:[String!]!,\$selectedTagsIds:[String!]!){betaSaveSelectedTags(excudedGroupsIds:\$excudedGroupsIds,selectedTagsIds:\$selectedTagsIds){__typename tagGroup{__typename id}}}"
