...
object Operations {
    ...
    val SendSticker = object: OperationDefinition {
        ...
        override val kind = OperationKind.MUTATION
        override val body = "mutation SendSticker(\$chatId:ID!,\$repeatKey:String,\$replyMessages:[ID!],\$stickerId:ID!){sendSticker:sendSticker(chatId:\$chatId,repeatKey:\$repeatKey,replyMessages:\$replyMessages,stickerId:\$stickerId)}"
