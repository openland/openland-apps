...
val UserForMentionSelector = obj(listOf(
            field("__typename","__typename", notNull(scalar("String"))),
            field("id","id", notNull(scalar("ID"))),
            field("name","name", notNull(scalar("String"))),
            field("photo","photo", scalar("String")),
...
val RoomMembersForMentionsPaginatedSelector = obj(listOf(
...
val AccountCreateInviteSelector = obj(listOf(
...
val AccountDestroyInviteSelector = obj(listOf(
            field("alphaDeleteInvite","alphaDeleteInvite", mapOf("id" to reference("id")), notNull(scalar("String")))
        ))
val AccountInviteJoinSelector = obj(listOf(
            field("alphaJoinInvite","alphaJoinInvite", mapOf("key" to reference("inviteKey")), notNull(scalar("ID")))
        ))
val AddAppToChatSelector = obj(listOf(
            field("addAppToChat","addAppToChat", mapOf("appId" to reference("appId"), "chatId" to reference("chatId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("AppChat", AppChatSelector)
                ))))
        ))
val AddMessageCommentSelector = obj(listOf(
            field("addMessageComment","addMessageComment", mapOf("fileAttachments" to reference("fileAttachments"), "mentions" to reference("mentions"), "message" to reference("message"), "messageId" to reference("messageId"), "replyComment" to reference("replyComment")), notNull(scalar("Boolean")))
        ))
val BetaAddMessageCommentSelector = obj(listOf(
            field("betaAddMessageComment","betaAddMessageComment", mapOf("fileAttachments" to reference("fileAttachments"), "mentions" to reference("mentions"), "message" to reference("message"), "messageId" to reference("messageId"), "replyComment" to reference("replyComment")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID")))
                ))))
        ))
val CancelTypingSelector = obj(listOf(
            field("typingCancel","typingCancel", mapOf("conversationId" to reference("conversationId")), notNull(scalar("String")))
        ))
val CommentSetReactionSelector = obj(listOf(
            field("commentReactionAdd","commentReactionAdd", mapOf("commentId" to reference("commentId"), "reaction" to reference("reaction")), notNull(scalar("Boolean")))
        ))
val CommentUnsetReactionSelector = obj(listOf(
            field("commentReactionRemove","commentReactionRemove", mapOf("commentId" to reference("commentId"), "reaction" to reference("reaction")), notNull(scalar("Boolean")))
        ))
val ConferenceAnswerSelector = obj(listOf(
            field("peerConnectionAnswer","peerConnectionAnswer", mapOf("answer" to reference("answer"), "id" to reference("id"), "ownPeerId" to reference("ownPeerId"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Conference", ConferenceFullSelector)
                ))))
        ))
val ConferenceCandidateSelector = obj(listOf(
            field("peerConnectionCandidate","peerConnectionCandidate", mapOf("candidate" to reference("candidate"), "id" to reference("id"), "ownPeerId" to reference("ownPeerId"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Conference", ConferenceFullSelector)
                ))))
        ))
val ConferenceJoinSelector = obj(listOf(
            field("conferenceJoin","conferenceJoin", mapOf("id" to reference("id")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
...
val ConferenceKeepAliveSelector = obj(listOf(
            field("conferenceKeepAlive","conferenceKeepAlive", mapOf("id" to reference("id"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Conference", ConferenceFullSelector)
                ))))
        ))
val ConferenceLeaveSelector = obj(listOf(
            field("conferenceLeave","conferenceLeave", mapOf("id" to reference("id"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Conference", ConferenceFullSelector)
                ))))
        ))
val ConferenceOfferSelector = obj(listOf(
            field("peerConnectionOffer","peerConnectionOffer", mapOf("id" to reference("id"), "offer" to reference("offer"), "ownPeerId" to reference("ownPeerId"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Conference", ConferenceFullSelector)
                ))))
        ))
val CreateAppSelector = obj(listOf(
            field("createApp","createApp", mapOf("about" to reference("about"), "name" to reference("name"), "photoRef" to reference("photoRef"), "shortname" to reference("shortname")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("AppProfile", AppFullSelector)
                ))))
        ))
val CreateOrganizationSelector = obj(listOf(
            field("createOrganization","organization", mapOf("input" to reference("input")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("name","name", notNull(scalar("String")))
                ))))
        ))
val CreateUserProfileAndOrganizationSelector = obj(listOf(
            field("alphaCreateUserProfileAndOrganization","alphaCreateUserProfileAndOrganization", mapOf("organization" to reference("organization"), "user" to reference("user")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("organization","organization", obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
                            field("id","id", notNull(scalar("ID"))),
...
val DebugMailsSelector = obj(listOf(
            field("debugSendEmail","debugSendEmail", mapOf("type" to reference("type")), scalar("Boolean"))
        ))
val DeleteCommentSelector = obj(listOf(
            field("deleteComment","deleteComment", mapOf("id" to reference("id")), notNull(scalar("Boolean")))
        ))
val DeleteOrganizationSelector = obj(listOf(
            field("deleteOrganization","deleteOrganization", mapOf("id" to reference("organizationId")), notNull(scalar("Boolean")))
        ))
val DeleteUserSelector = obj(listOf(
            field("superDeleteUser","superDeleteUser", mapOf("id" to reference("id")), notNull(scalar("Boolean")))
        ))
val EditCommentSelector = obj(listOf(
            field("editComment","editComment", mapOf("id" to reference("id"), "message" to reference("message")), notNull(scalar("Boolean")))
        ))
val EditPostMessageSelector = obj(listOf(
            field("alphaEditPostMessage","editPostMessage", mapOf("attachments" to reference("attachments"), "messageId" to reference("messageId"), "postType" to reference("postType"), "text" to reference("text"), "title" to reference("title")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("seq","seq", notNull(scalar("Int")))
                ))))
        ))
val FeatureFlagAddSelector = obj(listOf(
            field("featureFlagAdd","featureFlagAdd", mapOf("key" to reference("key"), "title" to reference("title")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("key","key", notNull(scalar("String"))),
                    field("title","title", notNull(scalar("String")))
...
val FeatureFlagDisableSelector = obj(listOf(
            field("superAccountFeatureRemove","superAccountFeatureRemove", mapOf("featureId" to reference("featureId"), "id" to reference("accountId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("features","features", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
                            field("id","id", notNull(scalar("ID"))),
...
val FeatureFlagEnableSelector = obj(listOf(
            field("superAccountFeatureAdd","superAccountFeatureAdd", mapOf("featureId" to reference("featureId"), "id" to reference("accountId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("features","features", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
                            field("id","id", notNull(scalar("ID"))),
...
val FeedPostSelector = obj(listOf(
            field("alphaCreateFeedPost","alphaCreateFeedPost", mapOf("message" to reference("message")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID")))
                ))))
        ))
val MarkSequenceReadSelector = obj(listOf(
            field("alphaGlobalRead","alphaGlobalRead", mapOf("toSeq" to reference("seq")), notNull(scalar("String")))
        ))
val MediaAnswerSelector = obj(listOf(
            field("mediaStreamAnswer","mediaStreamAnswer", mapOf("answer" to reference("answer"), "id" to reference("id"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("streams","streams", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val MediaCandidateSelector = obj(listOf(
            field("mediaStreamCandidate","mediaStreamCandidate", mapOf("candidate" to reference("candidate"), "id" to reference("id"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("streams","streams", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val MediaOfferSelector = obj(listOf(
            field("mediaStreamOffer","mediaStreamOffer", mapOf("id" to reference("id"), "offer" to reference("offer"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("streams","streams", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val MessageSetReactionSelector = obj(listOf(
            field("betaReactionSet","betaReactionSet", mapOf("mid" to reference("messageId"), "reaction" to reference("reaction")), notNull(scalar("Boolean")))
        ))
val MessageUnsetReactionSelector = obj(listOf(
            field("betaReactionRemove","betaReactionRemove", mapOf("mid" to reference("messageId"), "reaction" to reference("reaction")), notNull(scalar("Boolean")))
        ))
val OrganizationActivateByInviteSelector = obj(listOf(
            field("joinAppInvite","joinAppInvite", mapOf("key" to reference("inviteKey")), notNull(scalar("ID")))
        ))
val OrganizationAddMemberSelector = obj(listOf(
            field("betaOrganizationMemberAdd","betaOrganizationMemberAdd", mapOf("organizationId" to reference("organizationId"), "userIds" to reference("userIds")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Organization", OrganizationFullSelector)
                ))))
        ))
val OrganizationAlterPublishedSelector = obj(listOf(
            field("alphaAlterPublished","alphaAlterPublished", mapOf("id" to reference("organizationId"), "published" to reference("published")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Organization", OrganizationSearchSelector)
                ))))
        ))
val OrganizationChangeMemberRoleSelector = obj(listOf(
            field("alphaOrganizationChangeMemberRole","alphaOrganizationChangeMemberRole", mapOf("memberId" to reference("memberId"), "newRole" to reference("newRole"), "organizationId" to reference("organizationId")), notNull(scalar("String")))
        ))
val OrganizationCreatePublicInviteSelector = obj(listOf(
            field("alphaOrganizationRefreshInviteLink","alphaOrganizationRefreshInviteLink", mapOf("expirationDays" to reference("expirationDays"), "organizationId" to reference("organizationId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("key","key", notNull(scalar("String"))),
                    field("ttl","ttl", scalar("String"))
...
val OrganizationInviteMembersSelector = obj(listOf(
            field("alphaOrganizationInviteMembers","alphaOrganizationInviteMembers", mapOf("inviteRequests" to reference("inviteRequests"), "organizationId" to reference("organizationId")), notNull(scalar("String")))
        ))
val OrganizationMemberRemoveSelector = obj(listOf(
            field("betaOrganizationMemberRemove","betaOrganizationMemberRemove", mapOf("organizationId" to reference("organizationId"), "userId" to reference("userId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID")))
                ))))
        ))
val OrganizationRemoveMemberSelector = obj(listOf(
            field("alphaOrganizationRemoveMember","alphaOrganizationRemoveMember", mapOf("memberId" to reference("memberId"), "organizationId" to reference("organizationId")), notNull(scalar("String")))
        ))
val PersistEventsSelector = obj(listOf(
            field("track","track", mapOf("did" to reference("did"), "events" to reference("events"), "isProd" to reference("isProd"), "platform" to reference("platform")), notNull(scalar("String")))
        ))
val PinMessageSelector = obj(listOf(
            field("betaPinMessage","pinMessage", mapOf("chatId" to reference("chatId"), "messageId" to reference("messageId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomShortSelector)
                ))))
        ))
val ProfileCreateSelector = obj(listOf(
            field("createProfile","createProfile", mapOf("input" to reference("input")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("about","about", scalar("String")),
                    field("email","email", scalar("String")),
                    field("firstName","firstName", scalar("String")),
...
val ProfileUpdateSelector = obj(listOf(
            field("updateProfile","updateProfile", mapOf("input" to reference("input"), "uid" to reference("uid")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("about","about", scalar("String")),
                    field("alphaInvitedBy","invitedBy", obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val RefreshAppTokenSelector = obj(listOf(
            field("refreshAppToken","refreshAppToken", mapOf("appId" to reference("appId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("AppProfile", AppFullSelector)
                ))))
        ))
val RegisterPushSelector = obj(listOf(
            field("registerPush","registerPush", mapOf("endpoint" to reference("endpoint"), "type" to reference("type")), notNull(scalar("String")))
        ))
val RegisterWebPushSelector = obj(listOf(
            field("registerWebPush","registerWebPush", mapOf("endpoint" to reference("endpoint")), notNull(scalar("String")))
        ))
val ReplyMessageSelector = obj(listOf(
            field("betaMessageSend","replyMessage", mapOf("mentions" to reference("mentions"), "message" to reference("message"), "replyMessages" to reference("replyMessages"), "room" to reference("roomId")), notNull(scalar("Boolean")))
        ))
val ReportOnlineSelector = obj(listOf(
            field("presenceReportOnline","presenceReportOnline", mapOf("active" to reference("active"), "platform" to reference("platform"), "timeout" to i(5000)), notNull(scalar("String")))
        ))
val RespondPostMessageSelector = obj(listOf(
            field("alphaRespondPostMessage","alphaRespondPostMessage", mapOf("buttonId" to reference("buttonId"), "messageId" to reference("messageId")), scalar("Boolean")),
            field("betaReactionSet","betaReactionSet", mapOf("mid" to reference("messageId"), "reaction" to reference("reaction")), notNull(scalar("Boolean")))
        ))
val RoomAddMemberSelector = obj(listOf(
            field("betaRoomInvite","betaRoomInvite", mapOf("invites" to listValue(objectValue("userId" to reference("userId"),"role" to s("MEMBER"))), "roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomAddMembersSelector = obj(listOf(
            field("betaRoomInvite","betaRoomInvite", mapOf("invites" to reference("invites"), "roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomAlterFeaturedSelector = obj(listOf(
            field("betaRoomAlterFeatured","betaRoomAlterFeatured", mapOf("featured" to reference("featured"), "roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("featured","featured", notNull(scalar("Boolean"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("listed","listed", notNull(scalar("Boolean")))
...
val RoomAlterHiddenSelector = obj(listOf(
            field("betaRoomAlterListed","betaRoomAlterListed", mapOf("listed" to reference("listed"), "roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("featured","featured", notNull(scalar("Boolean"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("listed","listed", notNull(scalar("Boolean")))
...
val RoomChangeRoleSelector = obj(listOf(
            field("betaRoomChangeRole","betaRoomChangeRole", mapOf("newRole" to reference("newRole"), "roomId" to reference("roomId"), "userId" to reference("userId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomCreateSelector = obj(listOf(
            field("betaRoomCreate","room", mapOf("channel" to reference("channel"), "description" to reference("description"), "kind" to reference("kind"), "members" to reference("members"), "message" to reference("message"), "organizationId" to reference("organizationId"), "photoRef" to reference("photoRef"), "title" to reference("title")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID")))
                ))))
        ))
val RoomCreateIntroSelector = obj(listOf(
            field("betaIntroSend","intro", mapOf("about" to reference("about"), "file" to reference("file"), "message" to reference("about"), "room" to reference("roomId"), "uid" to reference("uid")), notNull(scalar("Boolean")))
        ))
val RoomDeclineJoinReuestSelector = obj(listOf(
            field("betaRoomDeclineJoinRequest","betaRoomDeclineJoinRequest", mapOf("roomId" to reference("roomId"), "userId" to reference("userId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomDeleteMessageSelector = obj(listOf(
            field("betaMessageDelete","betaMessageDelete", mapOf("mid" to reference("messageId")), notNull(scalar("Boolean")))
        ))
val RoomDeleteMessagesSelector = obj(listOf(
            field("betaMessageDelete","betaMessageDelete", mapOf("mids" to reference("mids")), notNull(scalar("Boolean")))
        ))
val RoomDeleteUrlAugmentationSelector = obj(listOf(
            field("betaMessageDeleteAugmentation","betaMessageDeleteAugmentation", mapOf("mid" to reference("messageId")), notNull(scalar("Boolean")))
        ))
val RoomEditIntroSelector = obj(listOf(
            field("betaIntroEdit","intro", mapOf("about" to reference("about"), "file" to reference("file"), "message" to reference("about"), "mid" to reference("messageId"), "uid" to reference("uid")), notNull(scalar("Boolean")))
        ))
val RoomEditMessageSelector = obj(listOf(
            field("betaMessageEdit","betaMessageEdit", mapOf("file" to reference("file"), "mentions" to reference("mentions"), "message" to reference("message"), "mid" to reference("messageId"), "replyMessages" to reference("replyMessages")), notNull(scalar("Boolean")))
        ))
val RoomJoinSelector = obj(listOf(
            field("betaRoomJoin","join", mapOf("roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomJoinInviteLinkSelector = obj(listOf(
            field("betaRoomInviteLinkJoin","join", mapOf("invite" to reference("invite")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomKickSelector = obj(listOf(
            field("betaRoomKick","betaRoomKick", mapOf("roomId" to reference("roomId"), "userId" to reference("userId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomLeaveSelector = obj(listOf(
            field("betaRoomLeave","betaRoomLeave", mapOf("roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomFullSelector)
                ))))
        ))
val RoomReadSelector = obj(listOf(
            field("roomRead","roomRead", mapOf("id" to reference("id"), "mid" to reference("mid")), notNull(scalar("Boolean")))
        ))
val RoomRenewInviteLinkSelector = obj(listOf(
            field("betaRoomInviteLinkRenew","link", mapOf("roomId" to reference("roomId")), notNull(scalar("String")))
        ))
val RoomSendEmailInviteSelector = obj(listOf(
            field("betaRoomInviteLinkSendEmail","betaRoomInviteLinkSendEmail", mapOf("inviteRequests" to reference("inviteRequests"), "roomId" to reference("roomId")), notNull(scalar("String")))
        ))
val RoomSettingsUpdateSelector = obj(listOf(
            field("betaRoomUpdateUserNotificationSettings","betaRoomUpdateUserNotificationSettings", mapOf("roomId" to reference("roomId"), "settings" to reference("settings")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("mute","mute", scalar("Boolean"))
                ))))
        ))
val RoomUpdateSelector = obj(listOf(
            field("betaRoomUpdate","betaRoomUpdate", mapOf("input" to reference("input"), "roomId" to reference("roomId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    inline("PrivateRoom", obj(listOf(
                        field("id","id", notNull(scalar("ID")))
                    ))),
...
val SaveDraftMessageSelector = obj(listOf(
            field("conversationDraftUpdate","conversationDraftUpdate", mapOf("conversationId" to reference("conversationId"), "message" to reference("message")), notNull(scalar("String")))
        ))
val SendMessageSelector = obj(listOf(
            field("betaMessageSend","sentMessage", mapOf("file" to reference("file"), "mentions" to reference("mentions"), "message" to reference("message"), "repeatKey" to reference("repeatKey"), "replyMessages" to reference("replyMessages"), "room" to reference("room")), notNull(scalar("Boolean")))
        ))
val SendPostMessageSelector = obj(listOf(
            field("alphaSendPostMessage","sendPostMessage", mapOf("attachments" to reference("attachments"), "conversationId" to reference("conversationId"), "postType" to reference("postType"), "text" to reference("text"), "title" to reference("title")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("seq","seq", notNull(scalar("Int")))
                ))))
        ))
val SetOrgShortnameSelector = obj(listOf(
            field("alphaSetOrgShortName","alphaSetOrgShortName", mapOf("id" to reference("organizationId"), "shortname" to reference("shortname")), scalar("String"))
        ))
val SetTypingSelector = obj(listOf(
            field("typingSend","typingSend", mapOf("conversationId" to reference("conversationId"), "type" to s("TEXT")), notNull(scalar("String")))
        ))
val SetUserShortnameSelector = obj(listOf(
            field("alphaSetUserShortName","alphaSetUserShortName", mapOf("shortname" to reference("shortname")), scalar("String"))
        ))
val SettingsUpdateSelector = obj(listOf(
            field("updateSettings","updateSettings", mapOf("settings" to reference("input")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Settings", SettingsFullSelector)
                ))))
        ))
val SuperAccountActivateSelector = obj(listOf(
            field("superAccountActivate","superAccountActivate", mapOf("id" to reference("accountId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("state","state", notNull(scalar("String")))
                ))))
        ))
val SuperAccountAddSelector = obj(listOf(
            field("superAccountAdd","superAccountAdd", mapOf("title" to reference("title")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID")))
                ))))
        ))
val SuperAccountMemberAddSelector = obj(listOf(
            field("superAccountMemberAdd","superAccountMemberAdd", mapOf("id" to reference("accountId"), "userId" to reference("userId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("members","members", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val SuperAccountMemberRemoveSelector = obj(listOf(
            field("superAccountMemberRemove","superAccountMemberRemove", mapOf("id" to reference("accountId"), "userId" to reference("userId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("members","members", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val SuperAccountPendSelector = obj(listOf(
            field("superAccountPend","superAccountPend", mapOf("id" to reference("accountId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("state","state", notNull(scalar("String")))
                ))))
        ))
val SuperAccountRenameSelector = obj(listOf(
            field("superAccountRename","superAccountRename", mapOf("id" to reference("accountId"), "title" to reference("title")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("title","title", notNull(scalar("String")))
                ))))
        ))
val SuperAccountSuspendSelector = obj(listOf(
            field("superAccountSuspend","superAccountSuspend", mapOf("id" to reference("accountId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("state","state", notNull(scalar("String")))
                ))))
        ))
val SuperAdminAddSelector = obj(listOf(
            field("superAdminAdd","superAdminAdd", mapOf("role" to reference("role"), "userId" to reference("userId")), notNull(scalar("String")))
        ))
val SuperAdminRemoveSelector = obj(listOf(
            field("superAdminRemove","superAdminRemove", mapOf("userId" to reference("userId")), notNull(scalar("String")))
        ))
val SwitchReactionSelector = obj(listOf(
            field("betaReactionRemove","betaReactionRemove", mapOf("mid" to reference("messageId"), "reaction" to reference("from")), notNull(scalar("Boolean"))),
            field("betaReactionSet","betaReactionSet", mapOf("mid" to reference("messageId"), "reaction" to reference("to")), notNull(scalar("Boolean")))
        ))
val UnpinMessageSelector = obj(listOf(
            field("betaUnpinMessage","unpinMessage", mapOf("chatId" to reference("chatId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Room", RoomShortSelector)
                ))))
        ))
val UpdateAppSelector = obj(listOf(
            field("updateAppProfile","updateAppProfile", mapOf("appId" to reference("appId"), "input" to reference("input")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("AppProfile", AppFullSelector)
                ))))
        ))
val UpdateOrganizationSelector = obj(listOf(
            field("updateOrganizationProfile","updateOrganizationProfile", mapOf("id" to reference("organizationId"), "input" to reference("input")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("OrganizationProfile", OrganizationProfileFullSelector)
                ))))
        ))
val UpdateWelcomeMessageSelector = obj(listOf(
            field("updateWelcomeMessage","updateWelcomeMessage", mapOf("roomId" to reference("roomId"), "welcomeMessageIsOn" to reference("welcomeMessageIsOn"), "welcomeMessageSender" to reference("welcomeMessageSender"), "welcomeMessageText" to reference("welcomeMessageText")), notNull(scalar("Boolean")))
        ))
val UserStorageSetSelector = obj(listOf(
            field("userStorageSet","userStorageSet", mapOf("data" to reference("data"), "namespace" to reference("namespace")), notNull(list(notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("key","key", notNull(scalar("String"))),
                    field("value","value", scalar("String"))
...
val ChatOnlinesCountWatchSelector = obj(listOf(
            field("chatOnlinesCount","chatOnlinesCount", mapOf("chatId" to reference("chatId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("onlineMembers","onlineMembers", notNull(scalar("Int")))
                ))))
        ))
val ChatWatchSelector = obj(listOf(
            field("chatUpdates","event", mapOf("chatId" to reference("chatId"), "fromState" to reference("state")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
...
val CommentWatchSelector = obj(listOf(
            field("commentUpdates","event", mapOf("fromState" to reference("fromState"), "peerId" to reference("peerId")), obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
...
val ConferenceMediaWatchSelector = obj(listOf(
            field("alphaConferenceMediaWatch","media", mapOf("id" to reference("id"), "peerId" to reference("peerId")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    field("id","id", notNull(scalar("ID"))),
                    field("streams","streams", notNull(list(notNull(obj(listOf(
                            field("__typename","__typename", notNull(scalar("String"))),
...
val ConferenceWatchSelector = obj(listOf(
            field("alphaConferenceWatch","alphaConferenceWatch", mapOf("id" to reference("id")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Conference", ConferenceFullSelector)
                ))))
        ))
val DialogsWatchSelector = obj(listOf(
            field("dialogsUpdates","event", mapOf("fromState" to reference("state")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
...
val OnlineWatchSelector = obj(listOf(
            field("alphaSubscribeChatOnline","alphaSubscribeChatOnline", mapOf("conversations" to reference("conversations")), notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
...
val SettingsWatchSelector = obj(listOf(
            field("watchSettings","watchSettings", notNull(obj(listOf(
                    field("__typename","__typename", notNull(scalar("String"))),
                    fragment("Settings", SettingsFullSelector)
                ))))
        ))
val TypingsWatchSelector = obj(listOf(
